...
- Added examples support to BaseTool for better LLM integration
  - Added `examples` property to `ToolProtocol` interface
  - Added `examples` abstract property to `MCPTool` class
  - Added example documentation for tool usage

### Changed

- Updated package name to `@magnolia-solutions/mcp-framework`
- Updated repository URLs and documentation to reflect fork status

### Fixed

- Fixed type error in `MCPTool` class by implementing required `examples` property from `ToolProtocol` interface

## [0.2.13] - 2024-03-19

### Original Release

- Initial fork from [mcp-framework](https://github.com/QuantGeekDev/mcp-framework) by [Alex Andru](https://github.com/alexandru)
